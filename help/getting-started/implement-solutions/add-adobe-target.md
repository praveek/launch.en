...
1. Make sure the Debugger maps the Launch property to your Development environment, as described earlier.
...
1. Open the Debugger, then go to the Target tab and expand your client code.
