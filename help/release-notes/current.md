...
* Code minification errors of user defined custom code, that may occur while building a library, have been enhanced to give the user more context about the error.
