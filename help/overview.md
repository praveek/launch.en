...
If you are already using legacy [!DNL DTM], or are currently deploying [!DNL DTM], you should continue to do so. Don't wait. Move your projects forward using the current [!DNL DTM]. Then, when you're ready to move to [!DNL Launch], the migration process will make it as easy and automated as possible (no on-page embed code changes, and automated migration of rules and data elements).
