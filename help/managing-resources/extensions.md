...
Important: Changes do not take effect until they are [published](../publishing/publishing-overview.md).
...
See [Extensions Reference](../extension-reference/extension-reference-overview.md) for details about the Adobe-owned extensions.
...
Each configurable extension has unique options. Refer to [Extensions Reference](../extension-reference/extension-reference-overview.md) for information about the options available for each Adobe extension.
