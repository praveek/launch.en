...
* [Experience Cloud ID Extension](../../extension-reference/web/experience-cloud-id-service-extension/overview.md)
...
![VA Extension Configuration](../../assets/ext-va-config.jpg)
